...
const WhatsAppInvite: React.FC = () => {
  return (
    <div className="relative mb-8">
      <div className="absolute inset-0 bg-gradient-to-r from-green-400 to-green-500 rounded-xl blur-md opacity-40"></div>
      <Card className="border-0 shadow-lg overflow-hidden relative bg-white rounded-xl">
        {/* Decorative elements */}
        ...
        <CardHeader>
          <h3 className="text-2xl font-semibold flex items-center gap-2 justify-center relative z-10">
